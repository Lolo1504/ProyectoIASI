...
// ------------------------------------------------------------
// Funciones de lectura y manipulación del tablero (sesiones 1 y 2)
// ------------------------------------------------------------
...
int MovimientoAbajo(const vector<vector<string>> &Tablero, int fila,
                    int columna, string letra) {
...
int MovimientoArriba(const vector<vector<string>> &Tablero, int fila,
                     int columna, string letra) {
...
int MovimientoIzq(const vector<vector<string>> &Tablero, int fila, int columna,
                  string letra) {
...
int MovimientoDer(const vector<vector<string>> &Tablero, int fila, int columna,
                  string letra) {
...
bool CandidatoX(const vector<vector<string>> &Tablero, int x, int y,
                string letra) {
    bool vertical = true;
...
bool CandidatoY(const vector<vector<string>> &Tablero, int x, int y,
                string letra) {
...
// ------------------------------------------------------------
// HEURÍSTICA: distancia mínima de Z a cualquier borde
// ------------------------------------------------------------
...
// ------------------------------------------------------------
// Mostrar todos los movimientos posibles con su heurística
// (lo que pide la sesión 3)
// ------------------------------------------------------------
void mostrarMovimientosConHeuristica(const vector<vector<string>> &Tablero) {
    int x, y;
    posicionX(x, y, Tablero);
    string letra;
...
int main() {
    ...
    // Mostrar movimientos con heurística (sesión 3)
    mostrarMovimientosConHeuristica(Tablero);
